...
while True:
    ...
    for r in results:
        ...
        for box in boxes:
            ...
            if clss == 0:
                ...
                cv2.circle(crop_color_img, (x1, y1), 5, (0, 0, 255), -1)  # 紅色圓點
                cv2.circle(crop_color_img, (x2, y1), 5, (0, 255, 0), -1)  # 綠色圓點
                cv2.circle(crop_color_img, (x2, y2), 5, (255, 0, 0), -1)  # 藍色圓點
    ...
    images = np.hstack((crop_color_img, crop_depth_img))
    ...
    if  s != 1 and (x_distance == None or y_distance == None or z_distance == None):
        ...
        detection(y_distance - 25, x_distance, -(z_distance - 100))
